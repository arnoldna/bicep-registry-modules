# Role Assignments (All scopes) `[Authorization/SubscriptionRoleAssignment]`

This module deploys a Role Assignment at the Subscription or Resource Group scope.
...
```bicep
module subscriptionRoleAssignment 'br/public:avm/ptn/authorization/subscription-role-assignment:<version>' = {
  name: 'subscriptionRoleAssignmentDeployment'
  params: {
    // Required parameters
