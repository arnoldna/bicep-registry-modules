...
resource loadBalancer 'Microsoft.Network/loadBalancers@2024-03-01' existing = {
  name: loadBalancerName
}

resource inboundNatRule 'Microsoft.Network/loadBalancers/inboundNatRules@2024-03-01' = {
  name: name
  properties: {
